...
export default function Footer() {
  ...
  return (
    <footer className="bg-dark border-t border-lime/10 px-6 md:px-12 py-12">
      <div className="max-w-[1200px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-6 text-center sm:text-left">
        ...
        <div className="flex gap-8">
          <a
            ...
            className="text-text-muted text-[13px] no-underline hover:text-lime transition-colors"
          >
            hello@techsana.kz
          </a>
        </div>
